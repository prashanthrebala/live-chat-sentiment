...
YOUTUBE_LIVE_URL = "https://www.youtube.com/watch?v=-mvtuJoLrxE"
# YOUTUBE_LIVE_URL = "https://www.youtube.com/watch?v=uyNCr-uvu1o"
...
if len(sys.argv) == 1:
    test_scraper_output(YOUTUBE_LIVE_URL)
else:
